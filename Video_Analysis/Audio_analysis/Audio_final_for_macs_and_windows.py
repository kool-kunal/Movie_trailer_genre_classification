...
results_dict={"Movie_name":[],"Action":[],"Romance":[],"Drama":[],"Horror":[]}
    ...
    for video_path in os.listdir(path):
        ...
        try:
            ...
            if(data1.shape[0]==0 or data2.shape[0]==0):
                ...
                print("Loading Model..")
                model=load_model("/Users/dhruvchandel/desktop/model_1.h5")
                ...
                results_dict["Movie_name"].append(name)
                results_dict["Action"].append(y_pred[0]*100)
                results_dict["Romance"].append(y_pred[1]*100)
                results_dict["Drama"].append(y_pred[2]*100)
                results_dict["Horror"].append(y_pred[3]*100)
        except:
            pass
            
    # df=pd.DataFrame(results_dict)
    # df.to_csv("C:\\Users\\karti\\Desktop\\testing\\Audio_Results.csv")
predict_genre()